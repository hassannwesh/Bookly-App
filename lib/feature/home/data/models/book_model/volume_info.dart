...
class VolumeInfo extends Equatable {
  ...
  factory VolumeInfo.fromMap(Map<String, dynamic> json) => VolumeInfo(
    ...
    readingModes: json['readingModes'] == null
        ? null
        : ReadingModes.fromMap(json['readingModes'] as Map<String, dynamic>),
    ...
    imageLinks: json['imageLinks']==null?null: ImageLinks.fromMap(json['imageLinks'] as Map<String, dynamic>),
